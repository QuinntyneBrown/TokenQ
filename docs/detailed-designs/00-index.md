...
| 03 | [File Output](03-file-output/README.md) | Accepted | `tokenq --name IFooService --output ./svc` writes the file to disk safely with overwrite control. | L2-004 (write), L2-006, L2-008 |
