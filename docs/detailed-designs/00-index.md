...
| 04 | [Logging](04-logging/README.md) | Accepted | Success and failure paths emit the right log levels to the right streams; `--verbose` reveals debug detail. | L2-010, L2-011 (verbose stack trace) |
