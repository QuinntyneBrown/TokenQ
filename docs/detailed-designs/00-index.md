...
| 08 | [`provide` Sub-command](08-provide-subcommand/README.md) | Complete | `tokenq provide --path ./dashboard-state` scans the folder, builds the barrel via slice 07, writes `index.ts` via the existing `FileWriter`. | L2-019, L2-020, L2-021 (I/O), L2-029, L2-030 |
